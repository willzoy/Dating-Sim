/// @description Initialization v1.11
/*
	Proverbs 3:5-8
...
with(object_index)
{
	if (other.id != id && image_angle == 0)
	{
		image_angle = -1; // Mark for destruction -- will prevent further initialization below
		instance_destroy(id, false);
	}
}

// Exit out early if marked for destruction
if (image_angle == -1) { exit; }

// Mark as being fully initiated
image_angle = 1; 
